                                ...
                                <div className="flex flex-col items-center gap-4">
                                    ...
                                    {status.type === 'success' && (
                                        <div className="flex flex-col gap-4 w-full mt-4">
                                            <p className="text-lg opacity-80 font-medium">
                                                Join the official whatsapp group to attend.
                                            </p>
                                            <a
                                            ...
                                            <button
                                                ...
                                                className="px-8 py-4 bg-white/5 hover:bg-white/10 rounded-[20px] text-sm font-bold transition-all text-white/60"
                                            >
                                                Dismiss
                                            </button>
                                        </div>
